...
export default function Testimonials() {
  const testimonials = [
    ...
    { quote: 'Our Caregiver was helpful in an emergency situation with our nanny\'s accident.', author: 'Client Family' },
    { quote: 'Joyful Home is going places. Overall, super excellent services.', author: 'Client Family' },
    { quote: 'Our Caregiver encouraged us to take baby to hospital when not well.', author: 'Client Family' },
