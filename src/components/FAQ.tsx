...
export default function FAQ() {
  ...
  const faqs = [
    ...
    { q: 'Can I provide specific instructions or preferences for my care?', a: 'Absolutely. We encourage you to share any specific instructions or preferences through our \'client needs assessment\' process. Our caregivers will tailor these needs and develop your individualised care plan.' },
