...
export default function FAQ() {
  ...
  const faqs = [
    ...
    { q: 'What is the process for scheduling and canceling services?', a: 'You can schedule services by contacting our customer service team. We request for at the least 1 month\'s notice for booking and 48-72 hours\' notice for cancellations to accommodate scheduling changes and ensure the availability of our caregivers.' },
    ...
    { q: 'What are your rates and payment options for care services?', a: 'Our rates depend on the level of care and hours of service required with daily, weekly and monthly packages. We offer flexible payment options including, flexipay, mobile money payments and direct bank transfers.' },
    ...
    <section id="faq" className="py-[96px] px-6 bg-neutral">
      <div className="max-w-[820px] mx-auto">
        <div className="text-center mb-12">
          <div className="font-passionate text-[30px] text-secondary mb-1">So, I was wondering...</div>
